...
/**
 * Created by viewqwest on 09/11/2017.
 */
...
public class NewItemsAdapter extends RecyclerView.Adapter<NewItemsAdapter.ViewHolder>   {
    ...
    public NewItemsAdapter(Context context, List<AllImageObject> imageList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.custom_new_single_item, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if(position==(getItemCount()-1)){
            ...
            intent.putExtra("Type", "ascending_order");
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            myView = (ImageView) itemView.findViewById(R.id.IV_new_items);
            itemView.setOnClickListener(this);
        }

        @Override
        public void onClick(View view) {
            if (mClickListener != null) mClickListener.onItemClick(view, getAdapterPosition(), "ascending_order");
        }
    }
