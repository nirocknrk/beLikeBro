...
public class RecentItemsAdapter extends RecyclerView.Adapter<RecentItemsAdapter.ViewHolder> {
    ...
    public RecentItemsAdapter(Context context, List<AllImageObject> imageList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.custom_recent_single_item, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if(position==(getItemCount()-1)){
            ...
            intent.putExtra("Type", "descending_order");
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            myView = (ImageView) itemView.findViewById(R.id.IV_recent_items);
            itemView.setOnClickListener(this);
        }

        @Override
        public void onClick(View view) {
            if (mClickListener != null) mClickListener.onItemClick(view, getAdapterPosition(), "descending_order");
        }
    }
